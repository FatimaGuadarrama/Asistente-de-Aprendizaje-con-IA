...
const DocumentListPage = () => {
  ...
  const fetchDocuments = async () => {
    try {
      ...
      toast.error("Error al recuperar los documentos.");
      console.error(error);
    } finally {
      setLoading(false);
    }
  ...
  const handleUpload = async (e) => {
    ...
    if (!uploadFile || !uploadTitle) {
      toast.error("Proporcione un título y seleccione un archivo.");
      return;
    }
    setUploading(true);
  ...
  const handleConfirmDelete = async () => {
    ...
    try {
      ...
      toast.success(`'${selectedDoc.title}' eliminado.`);
        ...
        <div className="flex items-center justify-center min-h-[400px]">
          <div className="text-center max-w-md">
            ...
            <p className="text-sm text-slate-500 mb-6">
              Empieza subiendo tu primer documento PDF 
  ...
  return (
    <div className="min-h-screen relative">
        ...
        <div className="flex items-center justify-between mb-10">
          <div>
            ...
            <p className="text-slate-500 text-sm">
              Gestiona y organiza tus materiales de aprendizaje
            </p>
          </div>
          ...
          <div className="relative w-full max-w-lg bg-white/95 backdrop-blur-xl border-slate-200/60 rounded-2xl shadow-2xl shadow-slate-900/20 p-8">
            ...
            <div className="mb-6">
              ...
              <p className="text-sm text-slate-500 mt-1">
                Añadir un documento PDF a tu biblioteca.
              </p>
            </div>
            ...
            <form onSubmit={handleUpload} className="space-y-5">
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  placeholder="e.g., Preparación para entrevistas de React"
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative border-2 border-dashed border-slate-300 rounded-xl bg-slate-50/50 hover:border-emerald-400 hover:bg-emerald-50/30 transition-all duration-200">
                  ...
                  <div className="flex flex-col items-center justify-center py-10 px-6">
                    ...
                    <p className="text-xs text-slate-500">PDF de hasta 10 MB</p>
                  </div>
                </div>
              </div>
      ...
      {isDeleteModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/50 backdrop-blur-sm">
          <div className="relative w-full max-w-md bg-white/95 backdrop-xl border border-slate-200/60 rounded-2xl shadow-slate-900/20 p-8">
            {/*Close button*/}
            <button
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/50 backdrop-blur-sm">
          <div className="relative w-full max-w-md bg-white/95 backdrop-blur-xl border-slate-200/60 rounded-2xl shadow-2xl shadow-slate-900/20 p-8">
            ...
            <div className="mb-6">
              ...
              <p className="text-sm text-slate-500 mt-1">
                Ingresa el código que te compartió el creador.
              </p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <button
                onClick={async () => {
                  setJoining(true);
                  try {
                    await documentService.joinDocumentByCode(joinCode);
                    toast.success("Documento agregado a tu biblioteca.");
                ...
                disabled={joining}
                className="w-full h-11 px-4 bg-linear-to-r from-emerald-500 to-teal-500 hover:from-emerald-600 hover:to-teal-600 text-white text-sm font-semibold rounded-xl transition-all duration-200 shadow-lg shadow-emerald-500/25 disabled:opacity-50 disabled:cursor-not-allowed active:scale-[0.98]"
              >
